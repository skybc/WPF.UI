...
public static class UiElementExtensions
{
    ...
    public static void SetDataContext(this FrameworkElement frameworkElement, object dataContext)
    {
    ...
    public static void SetDataContext<T>(this FrameworkElement frameworkElement) where T : class, new()
    {
        if (frameworkElement == null)
        {
            return;
        }
        frameworkElement.DataContext = new T();
    }
